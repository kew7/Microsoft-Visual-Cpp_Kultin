...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->oleDbSelectCommand1->Parameters->AddRange(gcnew cli::array< System::Data::OleDb::OleDbParameter^  >(1) {(gcnew System::Data::OleDb::OleDbParameter(L"name", 
				System::Data::OleDb::OleDbType::WChar, 50, L"name"))});
			// 
			// oleDbInsertCommand1
			// 
			...
			this->dataGridView1->Size = System::Drawing::Size(432, 177);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(21, 221);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(140, 219);
